...
public class Day08 : BaseDay
{
    ...
    public override ValueTask<string> Solve_2()
    {
        ...
        //            for (int x = 0; x < _antennaMap[0].Count(); x++) // i
        //            {
        //                for (int y = 0; y < _antennaMap.Count; y++) // j
        //                {
        //                    // Is this point on the line?
        //                    int pi = x - p1.i;
        //                    int pj = y - p1.j;
        //                    if (pi * reducedRise == pj * reducedRun) // could be wrong
        //                    {
        //                        // Is it outside the two points?
        //                        if (!(x > minI && x < maxI && y > minJ && y < maxJ))
        //                        {
        //                            // Only add if they're in the map
        //                            if (x >= 0 && x < _antennaMap[0].Count() &&
        //                                y >= 0 && y < _antennaMap.Count)
        //                            {
        //                                antinodes.Add((x,y));
        //                            }
